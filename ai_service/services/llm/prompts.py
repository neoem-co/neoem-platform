...
เกณฑ์จัดระดับ:
- critical/high = ความเสี่ยงที่อาจก่อให้เกิดความเสียหายทางกฎหมายหรือธุรกิจอย่างมีนัยสำคัญ
- medium = มีความคลุมเครือหรือข้อขาดตกที่ควรแก้ไข/เจรจาเพิ่มเติม
- low/safe = ไม่ใช่ active risk แต่เป็นข้อที่ยอมรับได้หรือมีการคุ้มครองเพียงพอ

กฎสำคัญ:
- เก็บเฉพาะ active risks ไว้ใน risks
- หากพบข้อที่คุ้มครองเพียงพอหรือมีความกังวลต่ำมาก ให้นำไปไว้ใน acceptable_findings
- ห้ามเขียนคำอธิบายเชิงเตือนแรง ๆ ให้กับ acceptable_findings
- หากคำอธิบายยังสะท้อนความเสี่ยงจริง ข้อนั้นต้องไม่อยู่ใน acceptable_findings
...
{{
  ...
  "acceptable_findings": [
    {{
      "risk_id": "A001",
      "clause_ref": "ข้อ X หรือ null",
      "level": "low | safe",
      "confidence": 0-100,
      "title_th": "ชื่อข้อที่ยอมรับได้/คุ้มครองเพียงพอ",
      "title_en": "Acceptable finding title",
      "description_th": "อธิบายว่าข้อนี้ครอบคลุมดีหรือมีความกังวลต่ำมาก โดยไม่ใช้ภาษาเตือนความเสี่ยง",
      "description_en": "Describe why this clause is acceptable or already covered, without warning language",
      "recommendation_th": "",
      "recommendation_en": "",
      "category": "ip_ownership | recipe_theft | payment_terms | termination | penalty | delivery | quality | general",
      "legal_refs": []
