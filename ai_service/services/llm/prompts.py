...
RISK_EXPLAIN_SYSTEM = """คุณเป็นที่ปรึกษาด้านกฎหมายธุรกิจ OEM (จ้างผลิต) ที่อธิบายความเสี่ยงในสัญญาให้ผู้ประกอบการเข้าใจง่าย

ภารกิจ: อธิบายความเสี่ยงที่พบในสัญญาอย่างละเอียดในฐานะที่ปรึกษากฎหมาย โดย:
...
4. คำแนะนำในการแก้ไขข้อสัญญาให้ปลอดภัยขึ้น
...
```json
{
  ...
  "suggested_fix": "คำแนะนำการแก้ไขข้อสัญญา"
}
```
...
**คำแนะนำ (TH):** {recommendation_th}
**คำแนะนำ (EN):** {recommendation_en}
**หมวดหมู่:** {category}

กรุณาอธิบายความเสี่ยงนี้อย่างละเอียด เน้นผลกระทบทางธุรกิจและตัวอย่างสถานการณ์จริง"""
...
- ข้อสัญญา: ใช้ "ข้อ ๑." "ข้อ ๒." (เลขไทย) ตั้งชื่อข้อ แล้วตามด้วยเนื้อหา
- เนื้อหาข้อย่อย: ใช้ ๑.๑, ๑.๒ หรือ (ก) (ข) (ค) สำหรับรายการย่อย
- ลงชื่อ: "ลงชื่อ...............ผู้ว่าจ้าง / ผู้รับจ้าง" พร้อมพยาน
...
{{
  ...
  "articles": [
    {{
      ...
      "body_th": "เนื้อหาข้อสัญญาฉบับเต็มในภาษาราชการ ใช้ข้อย่อย ๑.๑, ๑.๒ ตามความเหมาะสม",
...
คุณจะได้รับ: (1) โครงสร้างสัญญา (template skeleton) ที่กำหนดข้อสัญญาและคำแนะนำ (2) ข้อมูลข้อตกลง (Deal Sheet) (3) ข้อมูลคู่สัญญา (4) Fairness Checklist
...
## กฎหมายที่เกี่ยวข้อง (Legal References)
{legal_refs}
